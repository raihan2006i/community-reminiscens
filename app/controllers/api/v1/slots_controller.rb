class Api::V1::SlotsController < Api::V1::BaseController
  ...
  def_param_group :update_slot do
    ...
    param :duration, :duration, desc: 'api.docs.resources.slots.common.params.duration', required: false
    param_group :common
  end
  ...
  api :GET, '/v1/slots', 'api.docs.resources.slots.index.short_desc'
  param_group :pagination
  error code: 400, desc: I18n.t('api.docs.resources.common.errors.bad_request')
  def index
    @slots = Slot.includes(:creator).paginate(page: params[:page] || 1, per_page: params[:per_page] || 10)
  end
  ...
  api :POST, '/v1/slots', 'api.docs.resources.slots.create.short_desc'
  ...
  def create
    @slot = Slot.new(permitted_create_params)
